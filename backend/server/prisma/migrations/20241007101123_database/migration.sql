...
CREATE TABLE `User` (
    ...
    `credito_crypto` DOUBLE NOT NULL DEFAULT 100,
...
-- AddForeignKey
ALTER TABLE `Stock` ADD CONSTRAINT `Stock_cryptoId_fkey` FOREIGN KEY (`cryptoId`) REFERENCES `Crypto`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
